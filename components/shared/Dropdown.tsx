...
const Dropdown = ({onChangeHandler, value}:DropdownProps) => {
  ...
  <SelectContent>
    ...
    <AlertDialog>
  <AlertDialogTrigger className="p-medium-14 flex w-full rounded-sm py-3 pl-8 text-primary-500 hiver:bg-primary-50 focus:text-primary-500">Add new category</AlertDialogTrigger>
